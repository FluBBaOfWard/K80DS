...
const ArcadeRom ironhorsRoms[16] = {
	...
	{"03f_h08.bin",  0x0100, 0x9f6ddf83}, // Red
	{"04f_h09.bin",  0x0100, 0xe6773825}, // Green
	{"05f_h10.bin",  0x0100, 0x30a57860}, // Blue
	{"10f_h11.bin",  0x0100, 0xa63e37d8}, // Sprites Pal LUT
	{"10f_h12.bin",  0x0100, 0x5eb33e73}, // Character Pal LUT
};
...
const ArcadeRom farwestRoms[19] = {
	...
	{ROM_REGION,     0x0500, (int)&promBase},
	{"ironcol.003",  0x0100, 0x3e3fca11}, // Red
	{"ironcol.001",  0x0100, 0xdfb13014}, // Green
	{"ironcol.002",  0x0100, 0x77c88430}, // Blue
	{"ironcol.005",  0x0100, 0x15077b9c}, // Sprites Pal LUT
	{"10f_h12.bin",  0x0100, 0x5eb33e73}, // Character Pal LUT
};
...
const ArcadeRom scotrshtRoms[16] = {
	...
	{"gx545_6301_8f.bin", 0x0100, 0xc1c7cf58}, // Sprites Pal LUT
	{"gx545_6301_7f.bin", 0x0100, 0x2b0cd233}, // Character Pal LUT
};
