...
extern const ArcadeRom ironhorsRoms[12];
extern const ArcadeRom ironhorshRoms[12];
extern const ArcadeRom dairesyaRoms[12];
extern const ArcadeRom farwestRoms[15];
extern const ArcadeRom scotrshtRoms[12];
